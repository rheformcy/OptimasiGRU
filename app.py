...
# PARAM BASELINE
# ======================================================
st.sidebar.header("⚙️ Baseline")
timestep = st.sidebar.number_input("Timestep", 1, 30, 1)

# ======================================================
# PARAM PSO
# ======================================================
st.sidebar.header("🚀 PSO")

particle = st.sidebar.number_input("Partikel", 1, value=5)
iterasi = st.sidebar.number_input("Iterasi", 1, value=3)
epoch = st.sidebar.number_input("Epoch Final", 1, value=30)
layer = st.sidebar.number_input("Layer", 1, 3, 1)
...
if uploaded_file:
    ...
    # ==================================================
        ...
        config_df = pd.DataFrame({
            "Parameter": ["Epoch", "Batch", "Units", "Dropout", "Learning Rate", "Timestep"],
            "Nilai": [GS_epoch, GS_batch, GS_units, GS_dropout, GS_lr, timestep]
        })

        st.dataframe(config_df, use_container_width=False)

        st.info("Model baseline berjalan otomatis...")
    ...
    # ==================================================
        ...
        if run:
            ...
            with st.spinner("Optimasi berjalan..."):
                ...
                cost, pos = optimizer.optimize(objective, iters=iterasi)
